...
craftingTable.addShaped("thermal_fluxduct", <item:thermal:energy_duct> *8, [
...
craftingTable.addShaped("thermal_fluidduct_windowed", <item:thermal:fluid_duct_windowed> *8, [
    [<item:thermal:fluid_duct>, <item:thermal:fluid_duct>, <item:thermal:fluid_duct>],
    [<item:thermal:fluid_duct>, <tag:items:thermal:glass/hardened>, <item:thermal:fluid_duct>],
    [<item:thermal:fluid_duct>, <item:thermal:fluid_duct>, <item:thermal:fluid_duct>]
]);

craftingTable.addShaped("thermal_fluidduct", <item:thermal:fluid_duct> *4, [
    [<item:minecraft:air>, <item:minecraft:air>, <item:minecraft:air>],
    [<tag:items:forge:ingots/bronze>, <item:the_vault:chromatic_steel_ingot>, <tag:items:forge:ingots/bronze>],
    [<item:minecraft:air>, <item:minecraft:air>, <item:minecraft:air>]
]);
