...
<blockstate:the_vault:vault_stone_slab:type=top>.addTargetedLootModifier("stone_slab_top",CommonLootModifiers.add(<item:the_vault:vault_stone_slab>));
<blockstate:the_vault:vault_stone_slab:type=bottom>.addTargetedLootModifier("stone_slab_bottom",CommonLootModifiers.add(<item:the_vault:vault_stone_slab>));
